...
class ExportTerrain : EditorWindow
{
    ...
    static Transform parentGameObjects;
    ...
    [MenuItem("Window/Export Terrain to Obj...")]
    static void Init()
    {
        terrain = null;
        ...
        parentGameObjects = terrainObject.transform;
    ...
    void Export()
    {
        ...
        try
        {
            ...
            // done writing terrain writer other objs now
            sw.WriteLine(ObjExporter.DoExport(parentGameObjects, tVertices.Length));
